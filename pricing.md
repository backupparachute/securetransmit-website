...
**What does "delete on ack" mean?** The moment the destination system acknowledges receipt, the file is deleted. No retention window, no waiting. The SHA-256 hash and the audit record stay forever. Breach exposes only in-flight data. Available on Pro and up. Default on Enterprise if you want it.
